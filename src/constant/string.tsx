...
export const useString = () => {
  return {
    ...
    unfortunately_your_application_could_not_be_approved_due_to_missing_or_invalid_documents: "Unfortunately, your application could not be approved due to missing or invalid documents.",
    upload_documents: "Upload Documents",
    upload: "Upload",
    documents_uploaded_successfully_your_documents_will_be_reviewed_within_72_hours: "Documents uploaded successfully. Your documents will be reviewed within 72 hours.",
    proceed: "Proceed",
    here_you_can_easily_manage_your_service_categories_each_additional_category_you_add_will_incur_a_monthly_fee_of: "Here, you can easily manage your service categories. Each additional category you add will incur a monthly fee of €1.",
    add_more_services: "Add more services",
    additional_category_you_add_will_incur_a_monthly_fee_of: "Additional category you add will incur a monthly fee of €1.",
    you_are_on_Non_professional_plan_that_s_why_you_need_to_pay_to_add_more_category_of_services: "You are on Non-professional plan, that’s why you need to pay €1 to add more category of services",
    ...
    update: "Update",
    are_you_sure_you_want_to_delete_your_account: "Are you sure you want to\ndelete your account?",
    delete_account_message: "This action cannot be reversed once your account is deleted. All of your data will be permanently erased. If you proceed, there will be no refunds issued.",
